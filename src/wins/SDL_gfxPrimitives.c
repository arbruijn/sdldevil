...
*/
int fastPixelColorNolock(SDL_Surface * dst, Sint16 x, Sint16 y, Uint32 color, gfxWriteMode mode)
{
	int bpp;
	Uint8 *p;
...
int fastPixelColor(SDL_Surface * dst, Sint16 x, Sint16 y, Uint32 color)
{
	...
	*/
	...
	result = fastPixelColorNolock(dst, x, y, color, 0);
...
int fastPixelRGBANolock(SDL_Surface * dst, Sint16 x, Sint16 y, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	...
	* Draw 
	*/
	return (fastPixelColorNolock(dst, x, y, color, 0));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int _putPixelAlpha(SDL_Surface *dst, Sint16 x, Sint16 y, Uint32 color, Uint8 alpha, gfxWriteMode mode)
{
...
\returns Returns 0 on success, -1 on failure.
*/
int pixelColor(SDL_Surface * dst, Sint16 x, Sint16 y, Uint32 color, gfxWriteMode mode)
{
	Uint8 alpha;
	Uint32 mcolor;
	int result = 0;
	...
	* Draw 
	*/
	result = _putPixelAlpha(dst, x, y, mcolor, alpha, mode);
...
int pixelColorNolock(SDL_Surface * dst, Sint16 x, Sint16 y, Uint32 color)
{
	...
	* Draw 
	*/
	result = _putPixelAlpha(dst, x, y, mcolor, alpha, 0);
...
int pixelColorWeight(SDL_Surface * dst, Sint16 x, Sint16 y, Uint32 color, Uint32 weight)
{
	...
	*/
	...
	return (pixelColor(dst, x, y, (color & (Uint32) 0xffffff00) | (Uint32) a, 0));
}
...
int pixelRGBA(SDL_Surface * dst, Sint16 x, Sint16 y, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	...
	*/
	if (a == 255) {
		...
		* Draw 
		*/
		return (pixelColor(dst, x, y, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a, 0));
	}
}
...
\returns Returns 0 on success, -1 on failure.
*/
int hlineColor(SDL_Surface * dst, Sint16 x1, Sint16 x2, Sint16 y, Uint32 color, gfxWriteMode mode)
{
	Sint16 left, right, top, bottom;
	Uint8 *pixel, *pixellast;
	int dx;
...
int hlineRGBA(SDL_Surface * dst, Sint16 x1, Sint16 x2, Sint16 y, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	...
	* Draw 
	*/
	return (hlineColor(dst, x1, x2, y, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a, 0));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int vlineColor(SDL_Surface * dst, Sint16 x, Sint16 y1, Sint16 y2, Uint32 color, gfxWriteMode mode)
{
	Sint16 left, right, top, bottom;
	Uint8 *pixel, *pixellast;
	int dy;
...
int vlineRGBA(SDL_Surface * dst, Sint16 x, Sint16 y1, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	...
	* Draw 
	*/
	return (vlineColor(dst, x, y1, y2, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a, 0));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int rectangleColor(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color, gfxWriteMode mode)
{
	int result;
	Sint16 tmp;
	...
	*/
	if (x1 == x2) {
		if (y1 == y2) {
			return (pixelColor(dst, x1, y1, color, mode));
		} else {
			return (vlineColor(dst, x1, y1, y2, color, mode));
		}
	} else {
		if (y1 == y2) {
			return (hlineColor(dst, x1, x2, y1, color, mode));
		}
	}
	...
	*/
	result = 0;
	result |= hlineColor(dst, x1, x2, y1, color, mode);
	result |= hlineColor(dst, x1, x2, y2, color, mode);
	y1 += 1;
	y2 -= 1;
	if (y1 <= y2) {
		result |= vlineColor(dst, x1, y1, y2, color, mode);
		result |= vlineColor(dst, x2, y1, y2, color, mode);
	}
...
int roundedRectangleColor(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 rad, Uint32 color)
{
	...
	*/
	if (rad == 0) {
		return rectangleColor(dst, x1, y1, x2, y2, color, 0);
	}
	...
	*/
	if (x1 == x2) {
		if (y1 == y2) {
			return (pixelColor(dst, x1, y1, color, 0));
		} else {
			return (vlineColor(dst, x1, y1, y2, color, 0));
		}
	} else {
		if (y1 == y2) {
			return (hlineColor(dst, x1, x2, y1, color, 0));
		}
	}
	...
	*/
	if (xx1 <= xx2) {
		result |= hlineColor(dst, xx1, xx2, y1, color, 0);
		result |= hlineColor(dst, xx1, xx2, y2, color, 0);
	}
	if (yy1 <= yy2) {
		result |= vlineColor(dst, x1, yy1, yy2, color, 0);
		result |= vlineColor(dst, x2, yy1, yy2, color, 0);
	}
...
int roundedBoxColor(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 rad, Uint32 color)
{
	...
	*/
	if (x1 == x2) {
		if (y1 == y2) {
			return (pixelColor(dst, x1, y1, color, 1));
		} else {
			return (vlineColor(dst, x1, y1, y2, color, 1));
		}
	} else {
		if (y1 == y2) {
			return (hlineColor(dst, x1, x2, y1, color, 1));
		}
	}
	...
	*/
	...
	yy2--;
	if (xx1 <= xx2) {
		result |= boxColor(dst, xx1, y1, xx2, y2, color, 0);
	}
	if (yy1 <= yy2) {
		result |= boxColor(dst, x1, yy1, xx1-1, yy2, color, 0);
		result |= boxColor(dst, xx2+1, yy1, x2, yy2, color, 0);
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int boxColor(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color, gfxWriteMode mode)
{
	Sint16 left, right, top, bottom;
	Uint8 *pixel, *pixellast;
	int x, dx;
...
int boxRGBA(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	...
	* Draw 
	*/
	return (boxColor(dst, x1, y1, x2, y2, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a, 0));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int lineColor(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color, gfxWriteMode mode)
{
	int pixx, pixy;
	int x, y;
	int dx, dy;
	...
	*/
	if (x1 == x2) {
		if (y1 < y2) {
			...
			return (vlineColor(dst, x1, y2, y1, color, mode));
		} else {
			return (pixelColor(dst, x1, y1, color, mode));
		}
	}
	if (y1 == y2) {
		if (x1 < x2) {
			...
			return (hlineColor(dst, x2, x1, y1, color, mode));
		}
	}
...
int lineRGBA(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	...
	* Draw 
	*/
	return (lineColor(dst, x1, y1, x2, y2, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a,0 ));
}
	...
	if (dx == 0) {
		...
		*/
		if (draw_endpoint)
		{
			...
			if (dy>0) {
				return (vlineColor(dst, x1, yy0, yy0+dy, color, 1));
			} else {
				return (pixelColor(dst, x1, y1, color, 1));
			}
		}
		...
		*/
		if (draw_endpoint)
		{
			...
			if (dx>0) {
				return (hlineColor(dst, xx0, xx0+dx, y1, color, 1));
			} else {
				return (pixelColor(dst, x1, y1, color, 1));
			}
		}
		...
		*/
		return (lineColor(dst, x1, y1, x2, y2, color, 0));
	}
...
#define CHECK_CLIPPING(dst, X, Y) ( (dst->clip_rect.x < X) && (dst->clip_rect.w + dst->clip_rect.x > X) && (dst->clip_rect.y < Y) && (dst->clip_rect.h + dst->clip_rect.y > Y) )


int circleColor(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, Uint32 color, gfxWriteMode mode)
{
	Sint16 left, right, top, bottom;
	int result;
	Sint16 x1, y1, x2, y2;
	...
	*/
	if (rad == 0) {
		return (pixelColor(dst, x, y, color, 0));
	}
		...
		*/
		do {
			...
			if (cx > 0) {
				xpcx = x + cx;
				xmcx = x - cx;
				if (CHECK_CLIPPING (dst, xmcx, ypcy)) 
					result |= fastPixelColorNolock(dst, xmcx, ypcy, color, mode);

				if (CHECK_CLIPPING (dst, xpcx, ypcy)) 
					result |= fastPixelColorNolock(dst, xpcx, ypcy, color, mode);
				
				if (CHECK_CLIPPING (dst, xmcx, ymcy)) 
					result |= fastPixelColorNolock(dst, xmcx, ymcy, color, mode);
			
				if (CHECK_CLIPPING (dst, xpcx, ymcy)) 
					result |= fastPixelColorNolock(dst, xpcx, ymcy, color, mode);
			} else {
				
				if (CHECK_CLIPPING (dst, x, ymcy)) 
					result |= fastPixelColorNolock(dst, x, ymcy, color, mode);

				if (CHECK_CLIPPING (dst, x, ypcy)) 
					result |= fastPixelColorNolock(dst, x, ypcy, color, mode);
			}
			xpcy = x + cy;
			xmcy = x - cy;
			...
			if ((cx > 0) && (cx != cy)) {
				...
				if (CHECK_CLIPPING (dst, xmcy, ypcx)) 
					result |= fastPixelColorNolock(dst, xmcy, ypcx, color, mode);

				if (CHECK_CLIPPING (dst, xpcy, ypcx)) 
					result |= fastPixelColorNolock(dst, xpcy, ypcx, color, mode);
				
				if (CHECK_CLIPPING (dst, xmcy, ymcx)) 
					result |= fastPixelColorNolock(dst, xmcy, ymcx, color, mode);

				if (CHECK_CLIPPING (dst, xpcy, ymcx)) 
					result |= fastPixelColorNolock(dst, xpcy, ymcx, color, mode);
			} else if (cx == 0) {

				if (CHECK_CLIPPING (dst, xmcy, y)) 
					result |= fastPixelColorNolock(dst, xmcy, y, color, mode);
				
				if (CHECK_CLIPPING (dst, xpcy, y)) 
					result |= fastPixelColorNolock(dst, xpcy, y, color, mode);
			}
			/*
			* Update 
			*/
...
int circleRGBA(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	...
	* Draw 
	*/
	return (circleColor(dst, x, y, rad, ((Uint32) r << 24) | ((Uint32) g << 16) | ((Uint32) b << 8) | (Uint32) a, 0));
}
		...
		*/
		do {
			...
			if (cx > 0) {
				...
				if (drawoct & 4)  result |= fastPixelColorNolock(dst, xmcx, ypcy, color, 0); // drawoct & 4 = 22; drawoct[2]
				if (drawoct & 2)  result |= fastPixelColorNolock(dst, xpcx, ypcy, color, 0);
				if (drawoct & 32) result |= fastPixelColorNolock(dst, xmcx, ymcy, color, 0);
				if (drawoct & 64) result |= fastPixelColorNolock(dst, xpcx, ymcy, color, 0);
			} else {
				if (drawoct & 6)  result |= fastPixelColorNolock(dst, x, ypcy, color, 0); // 4 + 2; drawoct[2] || drawoct[1]
				if (drawoct & 96) result |= fastPixelColorNolock(dst, x, ymcy, color, 0); // 32 + 64
			}
			...
			if (cx > 0 && cx != cy) {
				ypcx = y + cx;
				ymcx = y - cx;
				if (drawoct & 8)   result |= fastPixelColorNolock(dst, xmcy, ypcx, color, 0);
				if (drawoct & 1)   result |= fastPixelColorNolock(dst, xpcy, ypcx, color, 0);
				if (drawoct & 16)  result |= fastPixelColorNolock(dst, xmcy, ymcx, color, 0);
				if (drawoct & 128) result |= fastPixelColorNolock(dst, xpcy, ymcx, color, 0);
			} else if (cx == 0) {
				if (drawoct & 24)  result |= fastPixelColorNolock(dst, xmcy, y, color, 0); // 8 + 16
				if (drawoct & 129) result |= fastPixelColorNolock(dst, xpcy, y, color, 0); // 1 + 128
			}
	...
	do {
		...
		if (ocy != cy) {
			if (cy > 0) {
				ypcy = y + cy;
				ymcy = y - cy;
				result |= hlineColor(dst, xmcx, xpcx, ypcy, color, 1);
				result |= hlineColor(dst, xmcx, xpcx, ymcy, color, 1);
			} else {
				result |= hlineColor(dst, xmcx, xpcx, y, color, 1);
			}
			ocy = cy;
		}
		if (ocx != cx) {
			if (cx != cy) {
				if (cx > 0) {
					ypcx = y + cx;
					ymcx = y - cx;
					result |= hlineColor(dst, xmcy, xpcy, ymcx, color, 1);
					result |= hlineColor(dst, xmcy, xpcy, ypcx, color, 1);
				} else {
					result |= hlineColor(dst, xmcy, xpcy, y, color, 1);
				}
			}
			ocx = cx;
		}
...
int ellipseColor(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint32 color)
{
	...
	*/
	if (rx == 0) {
		return (vlineColor(dst, x, y - ry, y + ry, color, 1));
	}
	/*
	* Special case for ry=0 - draw a hline 
	*/
	if (ry == 0) {
		return (hlineColor(dst, x - rx, x + rx, y, color, 1));
	}
			...
			do {
				...
				if (((ok != k) && (oj != k)) || ((oj != j) && (ok != j)) || (k != j)) {
					...
					if (k > 0) {
						ypk = y + k;
						ymk = y - k;
						result |= fastPixelColorNolock(dst, xmh, ypk, color, 0);
						result |= fastPixelColorNolock(dst, xph, ypk, color, 0);
						result |= fastPixelColorNolock(dst, xmh, ymk, color, 0);
						result |= fastPixelColorNolock(dst, xph, ymk, color, 0);
					} else {
						result |= fastPixelColorNolock(dst, xmh, y, color, 0);
						result |= fastPixelColorNolock(dst, xph, y, color, 0);
					}
					ok = k;
					xpi = x + i;
					xmi = x - i;
					if (j > 0) {
						ypj = y + j;
						ymj = y - j;
						result |= fastPixelColorNolock(dst, xmi, ypj, color, 0);
						result |= fastPixelColorNolock(dst, xpi, ypj, color, 0);
						result |= fastPixelColorNolock(dst, xmi, ymj, color, 0);
						result |= fastPixelColorNolock(dst, xpi, ymj, color, 0);
					} else {
						result |= fastPixelColorNolock(dst, xmi, y, color, 0);
						result |= fastPixelColorNolock(dst, xpi, y, color, 0);
					}
					oj = j;
				}
			...
			do {
				...
				if (((oi != i) && (oh != i)) || ((oh != h) && (oi != h) && (i != h))) {
					...
					if (i > 0) {
						ypi = y + i;
						ymi = y - i;
						result |= fastPixelColorNolock(dst, xmj, ypi, color, 0);
						result |= fastPixelColorNolock(dst, xpj, ypi, color, 0);
						result |= fastPixelColorNolock(dst, xmj, ymi, color, 0);
						result |= fastPixelColorNolock(dst, xpj, ymi, color, 0);
					} else {
						result |= fastPixelColorNolock(dst, xmj, y, color, 0);
						result |= fastPixelColorNolock(dst, xpj, y, color, 0);
					}
					oi = i;
					xmk = x - k;
					xpk = x + k;
					if (h > 0) {
						yph = y + h;
						ymh = y - h;
						result |= fastPixelColorNolock(dst, xmk, yph, color, 0);
						result |= fastPixelColorNolock(dst, xpk, yph, color, 0);
						result |= fastPixelColorNolock(dst, xmk, ymh, color, 0);
						result |= fastPixelColorNolock(dst, xpk, ymh, color, 0);
					} else {
						result |= fastPixelColorNolock(dst, xmk, y, color, 0);
						result |= fastPixelColorNolock(dst, xpk, y, color, 0);
					}
					oh = h;
				}
			...
			do {
				...
				if (((ok != k) && (oj != k)) || ((oj != j) && (ok != j)) || (k != j)) {
					...
					if (j > 0) {
						...
						result |= pixelColor(dst, xpi, ymj, color, 0);
					} else {
	...
	if (rx > ry) {
		...
		do {
			...
			if ((ok != k) && (oj != k)) {
				...
				xmh = x - h;
				if (k > 0) {
					result |= hlineColor(dst, xmh, xph, y + k, color, 0);
					result |= hlineColor(dst, xmh, xph, y - k, color, 0);
				} else {
					result |= hlineColor(dst, xmh, xph, y, color, 0);
				}
				ok = k;
			}
			if ((oj != j) && (ok != j) && (k != j)) {
				...
				xpi = x + i;
				if (j > 0) {
					result |= hlineColor(dst, xmi, xpi, y + j, color, 0);
					result |= hlineColor(dst, xmi, xpi, y - j, color, 0);
				} else {
					result |= hlineColor(dst, xmi, xpi, y, color, 0);
				}
				oj = j;
			}
		...
		do {
			...
			if ((oi != i) && (oh != i)) {
				...
				xpj = x + j;
				if (i > 0) {
					result |= hlineColor(dst, xmj, xpj, y + i, color, 0);
					result |= hlineColor(dst, xmj, xpj, y - i, color, 0);
				} else {
					result |= hlineColor(dst, xmj, xpj, y, color, 0);
				}
				oi = i;
			}
			if ((oh != h) && (oi != h) && (i != h)) {
				...
				xpk = x + k;
				if (h > 0) {
					result |= hlineColor(dst, xmk, xpk, y + h, color, 0);
					result |= hlineColor(dst, xmk, xpk, y - h, color, 0);
				} else {
					result |= hlineColor(dst, xmk, xpk, y, color, 0);
				}
				oh = h;
			}
...
int _pieColor(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rad, Sint16 start, Sint16 end, Uint32 color, Uint8 filled)
{
	...
	*/
	...
	if (numpoints<3)
	{
		result = lineColor(dst, vx[0], vy[0], vx[1], vy[1], color, 0);
	}
	else
	{
...
int polygonColor(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, Uint32 color)
{
	...
	*/
	result = 0;
	for (i = 1; i < n; i++) {
		result |= lineColor(dst, *x1, *y1, *x2, *y2, color, 0);
		x1 = x2;
		y1 = y2;
		x2++;
		y2++;
	}
	result |= lineColor(dst, *x1, *y1, *vx, *vy, color, 0);
	...
	*/
	...
	for (y = miny; (y <= maxy); y++) {
		...
		for (i = 0; (i < ints); i += 2) {
			...
			result |= hlineColor(dst, xa, xb, y, color, 0);
		}
	}
...
{	
	...
	if ((x1 == x2) && (y1 == y2)) {
		wh = width / 2;
		return boxColor(dst, x1 - wh, y1 - wh, x2 + width, y2 + width, color, 0);		
	}
