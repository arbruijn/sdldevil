...
void dec_quit(struct ws_event *w, int ec)
 { /*w->w_flags=w_f_end;*/ }
 
void main(void)
 {
 struct w_window *w1,*w2,iw1={0,100,100,200,200,200,200,0,"BLA",'x',
  "Dies ist ein Helptext der automatisch formatiert wird",
  wb_drag|wb_size|wb_close,wr_normal,NULL,NULL,NULL};
 ...
 if(!w_initwins(640,480,24,"wins.fnt"))
