...
/*  DEVIL - Descent Editor for Vertices, Items and Levels at all
    credits.h - the credits. if you falsify it, Devil will format
     your harddisk and let your monitor explode. if you've done some
     work on Devil you can put a note inside but better idea is to
     sent me your work so I can do the note inside and your work in
     Devil.
...
const char *cred_txt[] = {
 "--- SDLDevil Info --------------------------------------------------------",
 "SDLDevil - Version "VERSION" - Date: "__DATE__" Time: "__TIME__,
 "DESCENT Editor for Vertices, Items and Levels at all",
 "sourceport to SDL for Win32 and Linux (and maybe other modern systems)",
 "Copyright 2012 Florian Feucht",
 "This is a modified version of DEVIL. If you experience problems please",
 "contact me, not Achim Stremplat",
 "For the latest release (with source code) try:",
 " http://sdldevil.sf.net",
 "--- Original Devil Info --------------------------------------------------",
